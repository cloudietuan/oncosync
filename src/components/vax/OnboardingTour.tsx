...
const WELCOME_STEPS: { title: string; description: string; Icon: typeof Microscope }[] = [
  ...
  {
    title: 'Navigation',
    description: 'Use the sidebar on the left to navigate between modules — they are grouped into Overview, Laboratory, Analysis, Monitoring, and Reports for easy access.',
    Icon: Compass,
  },
  {
