          ...
          {datedCount < 2 ? (
            ...
            <ResponsiveContainer width="100%" height={220}>
              <LineChart data={chartData} margin={{ top: 5, right: 20, bottom: 30, left: 5 }}>
                ...
                <YAxis domain={[0, 100]} tick={{ fontSize: 10 }} width={35} stroke="hsl(220,8%,52%)" label={{ value: 'Proxy Score', angle: -90, position: 'insideLeft', offset: 8, style: { fontSize: 10, fill: 'hsl(220,8%,52%)' } }} />
