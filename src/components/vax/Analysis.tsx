            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="vax-card">
                ...
                <ResponsiveContainer width="100%" height={360}>
                  <BarChart data={analysisResults.correlations.slice(0, 8)} margin={{ top: 5, right: 20, bottom: 50, left: 15 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="hsl(270,13%,82%)" />
                    <XAxis dataKey="gene" stroke="hsl(270,9%,46%)" tick={{ fontSize: 11 }} angle={-35} textAnchor="end" height={70} />
