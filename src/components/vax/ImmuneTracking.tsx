          ...
          <div className="vax-card">
            ...
            <ResponsiveContainer width="100%" height={360}>
              <LineChart data={chartData} margin={{ top: 10, right: 20, left: 0, bottom: 10 }}>
                ...
                <Legend formatter={(value: string) => { const p = profiles.find(pr => pr.id === value); return p ? p.name : value; }} />
      ...
      {activeTab === 'all-markers' && (
        <div className="space-y-6">
          ...
          <div className="vax-card">
            ...
            <ResponsiveContainer width="100%" height={360}>
              <ComposedChart data={allMarkersData} margin={{ top: 10, right: 60, left: 0, bottom: 10 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#f4f4f5" />
                <XAxis dataKey="date" stroke="#a1a1aa" tick={{ fontSize: 11 }} />
            ...
            <div key={profile.id} className="space-y-4">
              ...
              <div className="vax-card">
                <ResponsiveContainer width="100%" height={280}>
                  <ComposedChart data={weeklyData} margin={{ top: 10, right: 60, left: 0, bottom: 10 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#f4f4f5" />
