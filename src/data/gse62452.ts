...
export const GSE62452_CLIN: ClinicalRecord[] = [
  {sample_id:'P001',time_to_event_days:1533,event:1,age:67,sex:'M',stage:'IIA'},
  {sample_id:'P003',time_to_event_days:81,event:1,age:72,sex:'F',stage:'III'},
  {sample_id:'P005',time_to_event_days:null,event:0,age:55,sex:'M',stage:'IIA'},
  {sample_id:'P007',time_to_event_days:72,event:1,age:61,sex:'M',stage:'III'},
  {sample_id:'P009',time_to_event_days:null,event:0,age:48,sex:'F',stage:'III'},
  {sample_id:'P011',time_to_event_days:585,event:1,age:74,sex:'M',stage:'III'},
  {sample_id:'P013',time_to_event_days:378,event:1,age:63,sex:'F',stage:'III'},
  {sample_id:'P015',time_to_event_days:480,event:1,age:58,sex:'M',stage:'III'},
  {sample_id:'P017',time_to_event_days:1227,event:1,age:52,sex:'F',stage:'III'},
  {sample_id:'P019',time_to_event_days:84,event:1,age:69,sex:'M',stage:'III'},
  {sample_id:'P021',time_to_event_days:348,event:1,age:71,sex:'F',stage:'III'},
  {sample_id:'P023',time_to_event_days:741,event:1,age:64,sex:'M',stage:'III'},
  {sample_id:'P025',time_to_event_days:1200,event:1,age:56,sex:'F',stage:'III'},
  {sample_id:'P027',time_to_event_days:36,event:1,age:78,sex:'M',stage:'IVA'},
  {sample_id:'P029',time_to_event_days:396,event:1,age:66,sex:'F',stage:'IVA'},
  {sample_id:'P031',time_to_event_days:696,event:1,age:59,sex:'M',stage:'III'},
  {sample_id:'P033',time_to_event_days:324,event:1,age:73,sex:'F',stage:'III'},
  {sample_id:'P035',time_to_event_days:870,event:1,age:51,sex:'M',stage:'IVA'},
  {sample_id:'P037',time_to_event_days:831,event:1,age:62,sex:'F',stage:'IVA'},
  {sample_id:'P039',time_to_event_days:828,event:1,age:57,sex:'M',stage:'III'},
  {sample_id:'P041',time_to_event_days:414,event:1,age:68,sex:'F',stage:'III'},
  {sample_id:'P043',time_to_event_days:204,event:1,age:75,sex:'M',stage:'IVB'},
  {sample_id:'P045',time_to_event_days:846,event:1,age:54,sex:'F',stage:'IVB'},
  {sample_id:'P047',time_to_event_days:294,event:1,age:70,sex:'M',stage:'III'},
  {sample_id:'P049',time_to_event_days:708,event:1,age:60,sex:'F',stage:'III'},
  {sample_id:'P051',time_to_event_days:231,event:1,age:76,sex:'M',stage:'III'},
  {sample_id:'P053',time_to_event_days:654,event:1,age:53,sex:'F',stage:'IIA'},
  {sample_id:'P055',time_to_event_days:636,event:1,age:65,sex:'M',stage:'IIA'},
  {sample_id:'P057',time_to_event_days:633,event:1,age:49,sex:'F',stage:'IIB'},
  {sample_id:'P059',time_to_event_days:267,event:1,age:77,sex:'M',stage:'IIB'}
];
